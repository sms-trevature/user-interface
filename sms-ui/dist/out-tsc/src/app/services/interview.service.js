...
var InterviewService = /** @class */ (function () {
    function InterviewService(httpCli) {
        this.httpCli = httpCli;
        this.urlVar = 'interview';
        this.interviewList = [
            {
                id: 1,
    ...
    InterviewService.prototype.getInterviews = function () {
        return this.httpCli.get(this.urlVar);
    };
    InterviewService.prototype.getInterviews2 = function () {
        return this.interviewList;
    };
    InterviewService = tslib_1.__decorate([
        Injectable({
            providedIn: 'root'
        }),
